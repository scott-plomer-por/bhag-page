...
const ChartOneNew = ({handleChange, handleSubmit, graphInputVal, chartCollectionNameSpace, setGraphInputVal, chartData}) => {
    
    return ( 
        <form className = 'form--newinput' action="">
            <label className = 'general--label' htmlFor="graphOneNew">Enter New Value Here</label>
                <input name = 'graphOneNew' className = 'general--input number' type="number" value = {graphInputVal} onChange = {(e)=>{handleChange(e)}}></input>
